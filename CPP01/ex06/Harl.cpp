...
void	Harl::complain( std::string level ) {
	...
	for ( i = 0; level != levels[i] && i < NB_LEVELS; i++ )
		;
...
std::string	Harl::_debugMsgs[NB_MSGS] = { "I'm on the verge of tears by the time we arrive at Espace since I'm positive we won't have a decent table. But we do, and relief washes over me in an awesome wave.",
	"I can't believe Bryce prefers Van Pattons card to mine",
	"Has anyone really been far even as decided to use even go want to do look more like?",
	"is meatball an fruit" };


std::string	Harl::_infoMsgs[NB_MSGS] = {  "Hey! Can you keep it down?? Im trying to do drugs!",
	"Don't sweat the petty things, and don't pet the sweaty things.",
	"Build a man a fire and he'll be warm for a night... Set a man on fire and he'll be warm for the rest of his life.",
	"I cannot believe adding extra bacon costs more money. You didn’t put enough bacon in my burger! If you did, I wouldn’t be asking for more!" };


std::string	Harl::_warningMsgs[NB_MSGS] = { "I think I deserve to have some extra bacon for free. \nI’ve been coming for years whereas you started working here since last month.",
	"They don't think it be like it is, but it do.",
	"Outside of a dog, a book is a man's best friend. \nInside of a dog, it's too dark to read.",
	"Look up \"idiot\" in the dictionary. You know what you'll find? \nA picture of me? \nNo! The definition of the word idiot, which you fucking are!" };


std::string	Harl::_errorMsgs[NB_MSGS] = { "If I had a gun with two bullets and I was in a room with Hitler, Bin Laden, and Toby, I would shoot you twice.",
